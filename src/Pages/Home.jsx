...
//   // Calculate categories dynamically from data
//   const categories = ["All", ...videoData.map((item) => item.category.name)];

//   const getFilteredData = () => {
//     let filtered = videoData;

//     if (selectedCategory !== "All") {
//       filtered = videoData.filter(
...
//   const totalVideos = videoData.reduce(
//     (acc, cat) => acc + cat.contents.length,
//     0,
//   );
...
//       {/* Header */}
//       <div className="sticky top-0 z-40 backdrop-blur-2xl bg-slate-950/80 border-b border-slate-800/50 shadow-xl shadow-black/20">
...
//                   }}
//                 />
//                 <div className="relative w-12 h-12 bg-gradient-to-br from-red-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-2xl">
...
//                     <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-slate-800">
...
//               <>
//                 {/* Category Hero */}
//                 <div className="mb-6 p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-3xl border border-slate-700/50 backdrop-blur-sm">
//                   <div className="flex items-center gap-4 mb-2">
//                     <img
//                       src={displayData[0].category.iconUrl}
//                       alt={displayData[0].category.name}
...
//                 className="mt-4 px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-full font-medium transition-colors"
//               >
//                 Clear search
//               </button>
//             )}
...
//     () => videoData.reduce((sum, cat) => sum + cat.contents.length, 0),
//     []
//   );
...
//                   <div className="w-12 h-12 flex items-center justify-center bg-slate-800 rounded-xl">
//                     <span className="text-2xl">{group.category.icon}</span>
//                   </div>
//                   <div>
//                     <h2 className="text-xl font-bold text-white">
