...
//       longPressTimer = window.setTimeout(() => {}, 500);
//     };
...
//       // Detect significant movement to distinguish from click
//       if (absX > 5 || absY > 5) {
...
//       // 🔁 Horizontal control (volume / brightness)
...
//       // For mouse events, use clientX directly. For touch, use changedTouches.
//       let clientX, clientY;
...
//         return;
//       }
//       // ✅ Tap handling (only if we haven't moved significantly)
...
//     // Attach move/up to window to handle dragging outside the element
